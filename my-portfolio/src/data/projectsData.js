// Project details mattume
export const projectsData = [
  {
    id: 1,
    title:"J.A.R.V.I.S (Virtual Assistant)",
    shortDesc: "Text and voice controlled AI assistant",
    problem: "Users need faster hands-free interaction with systems",
    solution: "Developed a voice assistant that handles commands, automation, and responses",
  ...
  },
  {
    ...
    problem: "There is no accessible, real-time MSL recognition tool available anywhere not in Malaysia",
    solution: "I combined computer vision, deep learning, and web streaming technology to create a full end-to-end assistive system.",
  ...
  },
  {
    ...
    problem: "There is no embedded system other than drone to spy, especially on land",
    solution: "Developed a robot car powered by arduino and developed an mobile app to control it",
    ...
    problem: "Develop an e-commerce system demonstrating java OOP and web development principle",
